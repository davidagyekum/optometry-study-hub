 ...
 * The global output ceilings were remeasured on the clean Notes V3 Batch 4
 * checkpoint after adding all eight route-lazy authored manuscript chunks. The
 * disabled profile measured 10,597,119 total bytes and 2,773,323 client-JS
 * bytes; only the crossed client-JS ceiling changed. Initial, server and
...
// Batch 4 measured 2,773,323 client-JS bytes; total output remains within the Batch 2 ceiling.
const GLOBAL_TOTAL_OUTPUT_BUDGET = 10_824_575;
const GLOBAL_CLIENT_JAVASCRIPT_BUDGET = 3_050_656;
