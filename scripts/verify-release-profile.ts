...
const committedFlagNames = [
  ...
  'SYSTEMIC_PATHOLOGY_CURATED_PRACTICE',
  'OPT370_SCHEMATIC_EYE_REFRACTIVE_STATES',
  'OPT370_MULTIFOCAL_FOUNDATIONS',
  'OPT370_PROGRESSIVE_ADDITION_LENSES',
  'OPT370_PD_AND_DISPENSING',
  'OPT370_SPECIAL_LENSES',
];
if (
