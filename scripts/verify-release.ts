...
const commands: Command[] = [
  ...
  { label: 'Tissue validation', command: npmCommand, args: npmArgs('run', 'questions:validate:tissue') },
  { label: 'Tissue report', command: npmCommand, args: npmArgs('run', 'questions:report:tissue') },
  { label: 'Tissue blueprint', command: npmCommand, args: npmArgs('run', 'questions:blueprint:tissue') },
  { label: 'Ocular Adnexa validation', command: npmCommand, args: npmArgs('run', 'questions:validate:ocular', '--', '--strict') },
  { label: 'Ocular Adnexa report', command: npmCommand, args: npmArgs('run', 'questions:report:ocular') },
  { label: 'Ocular Adnexa blueprint', command: npmCommand, args: npmArgs('run', 'questions:blueprint:ocular') },
  { label: 'Blood Supply validation', command: npmCommand, args: npmArgs('run', 'questions:validate:blood', '--', '--strict') },
  { label: 'Blood Supply report', command: npmCommand, args: npmArgs('run', 'questions:report:blood') },
  { label: 'Blood Supply blueprint', command: npmCommand, args: npmArgs('run', 'questions:blueprint:blood') },
  { label: 'Environmental Vision validation', command: npmCommand, args: npmArgs('run', 'questions:validate:environmental-vision', '--', '--strict') },
  { label: 'Environmental Vision report', command: npmCommand, args: npmArgs('run', 'questions:report:environmental-vision') },
  { label: 'Environmental Vision blueprint', command: npmCommand, args: npmArgs('run', 'questions:blueprint:environmental-vision') },
