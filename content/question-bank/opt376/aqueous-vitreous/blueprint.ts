...
export const aqueousVitreousBlueprint: QuestionBlueprint = {
  ...
  formatTargets: { single_best_answer: 12, multiple_response: 4, ordering: 4, matching: 4, extended_matching: 3, image_hotspot: 3, image_label: 2, short_answer: 2, open_response: 2 },
