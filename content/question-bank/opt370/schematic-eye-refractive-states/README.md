# OPT 370 - Schematic Eye and Refractive States question package
...
1. Copy this directory under `content/question-bank/opt370/schematic-eye-refractive-states/` or adapt to the current repository convention.
