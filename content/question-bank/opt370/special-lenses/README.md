# OPT 370 - Special Ophthalmic Lenses question package

- Module ID: `special-lenses`
...
1. Copy this directory under `content/question-bank/opt370/special-lenses/` or adapt to the current repository convention.
