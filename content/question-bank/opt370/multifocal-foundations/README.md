# OPT 370 - Presbyopia, Bifocals and Trifocals question package

- Module ID: `multifocal-foundations`
...
1. Copy this directory under `content/question-bank/opt370/multifocal-foundations/` or adapt to the current repository convention.
